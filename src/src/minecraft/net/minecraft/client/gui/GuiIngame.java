...
import club.aspect.impl.events.EventRender;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EventRender eventRender = new EventRender(partialTicks,scaledresolution, EventRender.State.Render2D);
        EventAPI.fire(eventRender);
    }
