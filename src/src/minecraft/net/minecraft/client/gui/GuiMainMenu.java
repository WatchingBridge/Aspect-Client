...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	Client.INSTANCE.getDiscordManager().update("IGN: " + mc.getSession().getUsername(), "Main Menu");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(fontRendererObj,Client.INSTANCE.getClientName() + " Client", sr.getScaledWidth() / 2f ,k + 90,Client.INSTANCE.getClientColorToInt());
...
//        this.drawCenteredString(this.fontRendererObj, "w/ "+Client.INSTANCE.getClientName()+" Client", 0, -8, Client.INSTANCE.getClientColorToInt());
