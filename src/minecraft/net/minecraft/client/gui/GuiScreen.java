...
import club.aspect.api.util.BackgroundShader;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        deltaTicks += RenderUtils.deltaTime * .01F;
    ...
    private void renderShader(){
        ...
        BackgroundShader.BackgroundShader.startShader();
        ...
        instance.draw();
        BackgroundShader.BackgroundShader.stopShader();
    }
