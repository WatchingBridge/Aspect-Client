...
import club.aspect.api.util.RenderUtils;
import club.aspect.impl.events.EventKey;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("aspect/logo/logo16.png"));
            	inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("aspect/logo/logo32.png"));
