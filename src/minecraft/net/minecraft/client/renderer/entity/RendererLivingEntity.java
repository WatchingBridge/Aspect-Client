...
import club.aspect.impl.events.EventRenderTag;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
        EventRenderTag eventRenderTag = new EventRenderTag();
        EventAPI.fire(eventRenderTag);

        if (eventRenderTag.isCancelled()){
            return;
        }
